          ...
          <div className="space-y-4">
            ...
            <div className="pt-4">
              ...
              <div className="flex space-x-4">
                ...
                <a href="https://www.linkedin.com/in/cantrell-thomas-151900266/" target="_blank" rel="noopener noreferrer" className="text-[#0A66C2] hover:opacity-80 transition-opacity">
