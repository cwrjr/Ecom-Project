...
export class MemStorage implements IStorage {
  ...
  private initializeData() {
    ...
    // Initialize products with authentic asset images
    const sampleProducts: Product[] = [
      {
        id: this.currentProductId++,
        name: "Wireless Headphones",
        description: "Premium wireless headphones with superior sound quality and comfort for extended use.",
        price: 149.99,
      ...
      },
      {
        id: this.currentProductId++,
        name: "Smart Speaker",
        description: "Voice-controlled smart speaker with built-in assistant and premium audio quality.",
        price: 89.99,
        originalPrice: null,
        category: "Electronics", 
      ...
      },
      {
        ...
        description: "High-end digital camera for photography enthusiasts and professionals.",
        price: 899.99,
        originalPrice: null,
        category: "Electronics",
      ...
      },
      {
        id: this.currentProductId++,
        name: "Desk Setup",
        description: "Complete minimal desk setup with curved monitor for productivity and professional work.",
        price: 299.99,
        originalPrice: null,
        category: "Home & Garden",
        image: "@assets/minimalist_expensive_desk_with_curved_monitor_that.jpg",
        tags: ["new", "office", "productivity"],
        featured: false,
        inStock: true,
        createdAt: new Date(),
      },
      {
        id: this.currentProductId++,
        name: "Desk Lamp",
        description: "Modern minimalist desk lamp with premium materials and adjustable lighting.",
        price: 179.99,
        originalPrice: null,
        category: "Home & Garden",
      ...
      },
      {
        ...
        description: "Fast wireless charging pad with sleek design and LED indicator for all compatible devices.",
        price: 79.99,
        originalPrice: 99.99,
        category: "Electronics",
        image: "@assets/magicstudio-art (1).jpg",
        tags: ["sale", "wireless", "charging"],
        featured: true,
        inStock: true,
        createdAt: new Date(),
      },
      {
        id: this.currentProductId++,
        name: "Coffee Setup",
        description: "Professional coffee brewing setup with premium equipment for the perfect cup every time.",
        price: 459.99,
        originalPrice: null,
        category: "Home & Garden",
        image: "@assets/pexels-karolina-grabowska-5902919.jpg",
        tags: ["coffee", "premium", "brewing"],
        featured: false,
        inStock: true,
        createdAt: new Date(),
      },
      {
        ...
        description: "Complete guide to cryptocurrency and digital investment strategies with expert insights.",
        price: 49.99,
        originalPrice: 79.99,
        category: "Books",
      ...
      },
      {
        id: this.currentProductId++,
        name: "Work Tools",
        description: "Professional work tools and equipment for enhanced productivity and efficiency.",
        price: 89.99,
        originalPrice: null,
        category: "Home & Garden",
        image: "@assets/pexels-tima-miroshnichenko-6266641.jpg",
        tags: ["tools", "professional", "work"],
        featured: false,
        inStock: true,
        createdAt: new Date(),
      },
      {
        ...
        description: "Essential tech accessories and gadgets for modern digital lifestyle.",
        price: 39.99,
        originalPrice: 49.99,
        category: "Electronics",
        image: "@assets/pexels-n-voitkevich-6214476.jpg",
